// User Trial Expired Modal
// Shows when 14-day trial has ended for individual users, blocks access until upgrade
...
interface UserTrialExpiredModalProps {
  open: boolean;
  userName?: string;
}

export default function UserTrialExpiredModal({ open, userName }: UserTrialExpiredModalProps) {
      ...
      >
        <DialogHeader className="text-center">
          ...
          <DialogDescription className="text-neutral-400 text-center">
            {userName ? (
              <>Hi <span className="text-white font-medium">{userName}</span>, your 14-day trial has expired.</>
            ) : (
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="bg-neutral-800/50 rounded-lg p-4 border border-neutral-700">
            ...
            <ul className="space-y-2 text-sm text-neutral-300">
              ...
              <li className="flex items-center gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-primary" />
                Personal audio library storage
              </li>
              <li className="flex items-center gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-primary" />
